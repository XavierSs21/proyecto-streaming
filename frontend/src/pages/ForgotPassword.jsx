...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await forgotPassword.mutateAsync({ correo: email });
      setEmailSent(true);
    } catch (error) {
      console.error(error);
    }
            ...
            <>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    {forgotPassword.isLoading ? 'Enviando...' : 'Enviar instrucciones'}
                  </Button>
                </form>
              </CardContent>
            </>
            ...
            <CardContent className="py-12 px-6">
               <div className="text-center space-y-6">
                 ...
                 <Link to="/login" className="block">
                   <Button 
                    variant="outline"
                    className="w-full border-zinc-700 text-black hover:bg-white"
                  >
